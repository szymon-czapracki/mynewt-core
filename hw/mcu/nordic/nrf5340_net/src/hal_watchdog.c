...
#ifdef MYNEWT_VAL(NRF5340_WDT_STOP)
...
#ifdef MYNEWT_VAL(NRF5340_WDT_STOP)
    NRF_WDT_NS->CONFIG = WDT_CONFIG_STOP_Msk | WDT_CONFIG_STOPEN_Msk;
#else
    NRF_WDT_NS->CONFIG = WDT_CONFIG_STOP_Msk;
#endif


    NRF_WDT_NS->CONFIG = wdt_cfg;
